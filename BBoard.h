...
class BBoard {
    private:
        string title;
        //string : title of the board; initialized via constructor
        
        vector<User> userList;
        //list of members; initially empty, then populated via loadUsers()
        
        const User *currentUser; //(Major change from previous assignment!)
        ...
        vector<Message *> messageList; //(Major change from previous assignment!)
        //list of message pointers, initially empty
